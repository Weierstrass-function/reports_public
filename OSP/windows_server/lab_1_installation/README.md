...
На виртуалке стоит чисто Server Core без графической оболочки. Для большего реализма будем работать через https://www.microsoft.com/de-de/evalcenter/download-windows-admin-center
